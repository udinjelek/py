...
--------------	
	...
	OOBTCSTAT_COMPCLI AS COMPCLI,
    OOBTCSTAT_COMPCLO AS COMPCLO,
    OOBTCSTAT_NOCOMPI AS NOCOMPI,
    OOBTCSTAT_NOCOMPO AS NOCOMPO,
    OOBTCSTAT_WBCPCLI AS WBCPCLI,
    OOBTCSTAT_WBCPCLO AS WBCPCLO
FROM
