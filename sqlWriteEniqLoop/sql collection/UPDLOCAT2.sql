...
--------------	
	...
	UPDLOCAT2_NLIM2OLDSUCC AS NLIM2OLDSUCC,
	UPDLOCAT2_NLLOCNRGTOT AS NLLOCNRGTOT, 
    UPDLOCAT2_NLLOCOLDTOT AS NLLOCOLDTOT, 
    UPDLOCAT2_NLLOCPERTOT AS NLLOCPERTOT, 
    UPDLOCAT2_NLLOCPUTOTNEW AS NLLOCPUTOTNEW, 
    UPDLOCAT2_NLLNOLDTOT AS NLLNOLDTOT
FROM
