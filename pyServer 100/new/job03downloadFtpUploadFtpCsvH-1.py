...
arrServerUse =[]
arrServerUse.append(["10.23.34.167","ftpuser","Changeme_123","HOST02_"])
arrServerUse.append(["10.23.34.179","ftpuser","Changeme_123","HOST03_"])
arrServerUse.append(["10.23.34.180","ftpuser","Changeme_123","HOST04_"])
...
noError = 0
directoryLog = os.path.dirname(__file__) + "\\dataLog03\\"
textError = ""

#========================================= Delete CSV File =========================================

folderPath = 'D:\ResultFtp\dataCsv03'
filePath = ""
	...
	for x02 in range(len(arrPmResult)):
		...
		for x03 in range(len(arrDate)):
			...
			for x04 in range(len(arrTime)):
				...
				if useTimeS == '23':
					vSourceFile		= useNoHost + "pmresult_" + usePmResult + "_60_" + useDate + useTimeS + "00_" + useDateEnd + useTimeE + "00.csv.gz"
				else:
					vSourceFile		= useNoHost + "pmresult_" + usePmResult + "_60_" + useDate + useTimeS + "00_" + useDate + useTimeE + "00.csv.gz"
				...
				vDestinTarget 	= "D:\\ResultFtp\\dataCsv03\\pmr" + usePmResult + "_Serv" + useServerShort + "_" + useDate + useTimeS +  ".csv.gz"
				vDestinTargetCsv = "D:\\ResultFtp\\dataCsv03\\pmr" + usePmResult + "_Serv" + useServerShort + "_" + useDate +  "_kirim.csv"
				#result should be like = "E:\ResultFtp\dataCsv03\Pm_1275071217_2019031019_Serv135.csv"
			...
			try:
				...
				ftpOut.storbinary('STOR pmresult_'+ usePmResult +'_serv166'+ useNoHost +'.txt', fileOpen)     # send the file
